...
module gtwizard_ultrascale_1_example_top (
    ...
    // input  wire mgtregclk0, 
    input  wire qpll1lock_in,
    input  wire qpll1clk_in,
    input  wire qpll1outrefclk_in,
    output wire qpll1_rst_out,
    ...
    assign tx_userclk_active_out = gtwiz_userclk_tx_active_int[0];
    ...
    assign rx_userclk_active_out = gtwiz_userclk_rx_active_int[0];
    ...
    assign rx_cdr_stable_out     = gtwiz_reset_rx_cdr_stable_int[0];
    ...
    assign gtpowergood_out       = gtpowergood_int[0];
    assign rxbyteisaligned_out   = rxbyteisaligned_int[0];
    assign rxbyterealign_out     = rxbyterealign_int[0];
    assign rxcommadet_out        = rxcommadet_int[0];
    ...
    gtwizard_ultrascale_1_example_wrapper example_wrapper_inst (
        ...
        .gtwiz_reset_clk_freerun_in         ({1{reset_clk_freerun_int}}),
        ...
        .gpll1lock_in                       (qpll1lock_in),
        .qpll1outclk_in                     (qpll1clk_in),
        .qpll1outrefclk_in                  (qpll1outrefclk_in),
        .qpll1_rst_out                      (qpll1_rst_out),
